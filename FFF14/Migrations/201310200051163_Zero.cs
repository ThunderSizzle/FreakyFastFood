    ...
    public partial class Zero : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.RID)
                .ForeignKey("dbo.Chains", t => t.Chain_RID1)
                .Index(t => t.Chain_RID1);
            ...
            CreateTable(
                "dbo.RepresentativeRestaurants",
                c => new
                    {
                        Representative_RID = c.Guid(nullable: false),
                        Restaurant_RID = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => new { t.Representative_RID, t.Restaurant_RID })
                .ForeignKey("dbo.Accounts", t => t.Representative_RID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Settings", "Profile_RID", "dbo.Profiles");
            DropForeignKey("dbo.Settings", "RID", "dbo.Objects");
            ...
            DropForeignKey("dbo.Objects", "Chain_RID1", "dbo.Chains");
            DropForeignKey("dbo.RepresentativeRestaurants", "Restaurant_RID", "dbo.Restaurants");
            DropForeignKey("dbo.RepresentativeRestaurants", "Representative_RID", "dbo.Accounts");
            ...
            DropIndex("dbo.Settings", new[] { "Profile_RID" });
            DropIndex("dbo.Settings", new[] { "RID" });
            ...
            DropIndex("dbo.Objects", new[] { "Chain_RID1" });
            DropIndex("dbo.RepresentativeRestaurants", new[] { "Restaurant_RID" });
            DropIndex("dbo.RepresentativeRestaurants", new[] { "Representative_RID" });
            ...
            DropTable("dbo.RepresentativeRestaurants");
